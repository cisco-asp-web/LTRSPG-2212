# Containerlab Ubuntu Utility Node: Rome (.109) – Dockerfile + Entrypoint Overview
...
This file corresponds to the **Rome** utility node.
...
```
docker build -t cl-rome-container:latest:latest .
```
